...
load(paste0("~/Downloads/flux_data_kit_beta/",sitename,"_flux_daytime_rollmean_14.Rdata"))
...
par_plant_leaf_pm = list(conductivity=0.35e-16, psi50=-1.2, b=1, tchome = quantile(phydro_input_subdaily$tc, c(.75)))
